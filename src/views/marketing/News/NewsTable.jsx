...
const NewsTable = ({ search }) => {
  ...
  const { data, isLoading, refetch } = useNewsList({
    params: { search, page: currentPage, limit, type: "news" },
    props: { enabled: true },
  });
              ...
              actions={[
                {
                  ...
                  title: t("change"),
                  action: () => {
                    history.push(`/home/marketing/news/${record.id}`);
                  },
                },
                {
                  icon: <DeleteIcon />,
                ...
                >
                  {columns?.map((col) => (
                    <TableCell
                      ...
                      onClick={() =>
                        history.push(`/home/marketing/news/${element.id}`)
                      }
                    >
