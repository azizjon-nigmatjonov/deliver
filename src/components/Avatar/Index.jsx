  ...
  return (
    ...
    >
      <div className="w-full h-full flex justify-center items-center relative">
        ...
        <p
          className={`${
            typeof textSize === "object" ? "" : textSize
...
function setSize(size, style) {
  if (size === "xl") {
    ...
    return {
      contentSize: "w-6 h-6",
      textSize: { fontSize: 9, lineHeight: 12 },
    };
  } else if (typeof size === "number") {
    return {
      contentSize: { width: size, height: size, ...style },
      textSize: { fontSize: (size * 3) / 8, lineHeight: `${size / 2}px` },
    };
  }
